...
# Read the data
data <- read_excel("C:/Users/sano/Downloads/udemyProject/Comments.xlsx")

# Filter the data to only include courses with ratings above 4
data <- data[data$rate > 2 & data$rate < 3, ]

# Create a corpus of the comments
